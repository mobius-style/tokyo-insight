...
ABSTAIN_MESSAGE = (
    "【該当なし／範囲外】このツールは東京都議会の常任委員会および決算特別委員会の"
    "速記録のみを対象としています。ご質問に直接対応する速記録が見つかりませんでした。"
    "（対象外の例：予算特別委員会の総括質疑、国会・他自治体の議事、将来予測、一般知識など。）"
    "委員会名や時期を絞って、都議会委員会の審議内容についてお尋ねください。"
)

SYSTEM = """あなたは東京都議会の委員会審議アシスタントです。

【対象範囲】東京都議会の常任委員会・決算特別委員会の速記録のみ。範囲外（予算特別委員会の総括質疑、国会、他自治体、将来予測、一般知識・雑談など）は扱いません。
